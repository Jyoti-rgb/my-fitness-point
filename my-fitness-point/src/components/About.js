...
function About() {
  return (
    <div>
      <section className="fullscreen" style={{ background: 'linear-gradient(to right, #fbc2eb, #a6c1ee)', padding: '50px 0', textAlign: 'center', color: '#fff' }}>
      ...
      <section className="fullscreen" style={{ background: 'linear-gradient(to right, #fbc2eb, #a6c1ee)', padding: '50px 0', textAlign: 'left', color: '#333' }}>
        <div className="container">
